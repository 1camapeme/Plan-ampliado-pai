...
FROM (
  ...
  WHERE esquemavacunacionii.fechaAtencion BETWEEN ? AND ?
  UNION ALL
  SELECT  esquemavacunacionii.Fie_amar_Dosis, 'Fie_amar' FROM esquemavacunacionii
  INNER JOIN datosusuario ON esquemavacunacionii.documentoPaciente = datosusuario.documento
  WHERE esquemavacunacionii.fechaAtencion BETWEEN ? AND ?
  UNION ALL
  ...
  WHERE esquemavacunacionii.fechaAtencion BETWEEN ? AND ?
  UNION ALL
  SELECT  esquemavacunacionii.Infl_Dosis, 'Infl' FROM esquemavacunacionii
  INNER JOIN datosusuario ON esquemavacunacionii.documentoPaciente = datosusuario.documento
  WHERE esquemavacunacionii.fechaAtencion BETWEEN ? AND ?
  UNION ALL
  SELECT  esquemavacunacionii.Vph_Dosis, 'Vph' FROM esquemavacunacionii
  INNER JOIN datosusuario ON esquemavacunacionii.documentoPaciente = datosusuario.documento
  WHERE esquemavacunacionii.fechaAtencion BETWEEN ? AND ?
  UNION ALL
...
mysqli_stmt_bind_param($stmt, "ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss", $startDate, $endDate, $startDate, $endDate, $startDate, $endDate, $startDate
